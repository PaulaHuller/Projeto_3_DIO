...
public class ClienteServiceImpl implements ClienteService {
	...
	public Cliente buscarPorId(Long id) {
		Optional<Cliente> cliente = clienteRepository.findById(id); // Buscar Cliente por ID.
		return cliente.get();
	}
	...
	public void atualizar(Long id, Cliente cliente) {
		Optional<Cliente> clienteBd = clienteRepository.findById(id); // Buscar Cliente por ID, caso exista:
